...
export {
  selectFromDecimalValue,
  decimalValueModelPrimitives,
  DecimalValueModelSelector,
} from './DecimalValueModel.base';

/**
 * DecimalValueModel
 */
export const DecimalValueModel = DecimalValueModelBase.actions(self => ({
