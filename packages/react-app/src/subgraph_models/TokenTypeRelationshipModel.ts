...
export {
  selectFromTokenTypeRelationship,
  tokenTypeRelationshipModelPrimitives,
  TokenTypeRelationshipModelSelector,
} from './TokenTypeRelationshipModel.base';

/**
 * TokenTypeRelationshipModel
 */
export const TokenTypeRelationshipModel = TokenTypeRelationshipModelBase.actions(self => ({
