...
contract ERC1155Composable is Initializable, ERC1155Upgradeable, ERC1155ReceiverUpgradeable, IERC1155Composable, AccessRestrictable {
    ...
    function _validateRecipientToken(
        ...
        require(
            ...
            "ERC1155Composable._validateRecipientToken: This contract has not been authorized to receive this token."
        );
        ...
        if (_from != address(0)) {
            require(
                ...
                "ERC1155Composable._validateRecipientToken: Only the owner of the parent token may add aditional child tokens."
            );
