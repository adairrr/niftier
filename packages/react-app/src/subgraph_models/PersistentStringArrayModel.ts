...
export { selectFromPersistentStringArray, persistentStringArrayModelPrimitives, PersistentStringArrayModelSelector } from "./PersistentStringArrayModel.base"

/**
 * PersistentStringArrayModel
 */
export const PersistentStringArrayModel = PersistentStringArrayModelBase
  .actions(self => ({
