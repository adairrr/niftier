...
import { Footer11DataSource } from './components/Landing/data.source';
...
function App(props) {
  ...
  */
  ...
  const accountDropdown = (
    <AccountDropdown web3Modal={web3Modal} loadWeb3Modal={loadWeb3Modal} logoutOfWeb3Modal={logoutOfWeb3Modal} />
  );
