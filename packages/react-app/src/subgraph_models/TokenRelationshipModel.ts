...
export {
  selectFromTokenRelationship,
  tokenRelationshipModelPrimitives,
  TokenRelationshipModelSelector,
} from './TokenRelationshipModel.base';

/**
 * TokenRelationshipModel
 */
export const TokenRelationshipModel = TokenRelationshipModelBase.actions(self => ({
