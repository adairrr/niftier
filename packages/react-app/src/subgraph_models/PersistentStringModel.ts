...
export {
  selectFromPersistentString,
  persistentStringModelPrimitives,
  PersistentStringModelSelector,
} from './PersistentStringModel.base';

/**
 * PersistentStringModel
 */
export const PersistentStringModel = PersistentStringModelBase.actions(self => ({
